...
同时，我们还提供了 [MMDetection 中文解读文案汇总](zh_cn/article.md)

若需要将2.x版本的代码迁移至新版，请参考[迁移文档](https://mmdetection.readthedocs.io/en/latest/migration.html)。

## 基准测试和模型库

测试结果和模型可以在[模型库](zh_cn/model_zoo.md)中找到。
...
我们在[基于 MMDetection 的项目](zh_cn/notes/projects.md)中列举了一些其他的支持的算法。

## 常见问题

请参考 [FAQ](zh_cn/notes/faq.md) 了解其他用户的常见问题。
